import {Button, Group, Modal, rem, Table, Tabs, Text, Title} from "@mantine/core";
import {IconFileArrowRight, IconFileImport, IconFilePlus, IconRestore} from "@tabler/icons-react";
...
export default function YourDocs(){
    ...
    //console.log(rows.filter(row => row.props.children[5].props.children === 'forms'));
            ...
            <Tabs defaultValue="all" value={activeTab} onChange={setActiveTab} style={{width: '70vw', marginTop: '5vh'}}>
                ...
                <Tabs.Panel value="contracts" pt="xs">
                    <Table stickyHeader stickyHeaderOffset={30}>
                        ...
                        <Table.Tbody>{rows.filter(row => row.props.children[5].props.children === 'contracts')}</Table.Tbody>
                    </Table>
                </Tabs.Panel>
                <Tabs.Panel value="forms" pt="xs">
                    <Table stickyHeader stickyHeaderOffset={30}>
                        ...
                        */}
                        <Table.Tbody>{rows.filter(row => row.props.children[5].props.children === 'forms')}</Table.Tbody>
                ...
                <Tabs.Panel value="other" pt="xs">
                    <Table stickyHeader stickyHeaderOffset={30}>
                        ...
                        <Table.Tbody>{rows.filter(row => row.props.children[5].props.children === 'others')}</Table.Tbody>
                    </Table>
                </Tabs.Panel>
            </Tabs>
